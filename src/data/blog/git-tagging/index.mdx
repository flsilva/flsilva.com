...
description: Learn what Git tagging is and how to use it to tag your software releases.
heroImage: './hero.jpg'
heroImageCreditText: 'Image by Freepik'
heroImageCreditUrl: 'https://www.freepik.com/free-photo/christmas-composition-with-tags_1449877.htm#&position=5&from_view=undefined'
priority: 0.6
slug: 'git-tagging'
tags: ['git']
title: Tagging with Git
tweetText: 'Learn how Git tagging works and how to use it to tag your software releases'
tweetVia: 'flsilva7'
---

import { WarningBoxNoRunDollarSign } from '../../../components/boxes/WarningBoxNoRunDollarSign';

If you're new to [Git](http://git-scm.com/) or want to know a little more about its basics and its distributed model, do not hesitate to read the [Introduction to Git](/blog/introducing-git/) article.
...
By default, the `$ git push` command doesn't send tags to remote repositories.
