...
description: Sometimes tricky issues arise in software development, but not all are bugs. In this article you'll learn solid parameters to make sure something really is a bug.
heroImage: './hero.jpg'
heroImageCreditText: 'Image by kuritafsheen77 on Freepik'
heroImageCreditUrl: 'https://www.freepik.com/free-photo/grasshopper-closeup-green-leaves-grasshopper-closeup-with-natural-background_27219202.htm#page=2&query=bug&position=7&from_view=search&track=sph'
priority: 0.6
slug: 'what-really-is-a-software-bug'
title: What is a software bug?
tweetText: 'Learn solid parameters to make sure whether tricky issues are really bugs or not.'
tweetVia: 'flsilva7'
---
...
[Software bug (Wikipedia)](http://en.wikipedia.org/wiki/Software_bug)<br />
[List of software bugs (Wikipedia)](http://en.wikipedia.org/wiki/List_of_software_bugs)
