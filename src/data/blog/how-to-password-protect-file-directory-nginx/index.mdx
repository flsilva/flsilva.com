...
description: Learn how to password-protect files and directories on Linux + Nginx in 4 steps using HTTP Authentication.
heroImage: './hero.jpg'
...
tags: ['linux', 'nginx', 'sysadmin', 'security']
title: How to password-protect content on Linux + Nginx
tweetText: 'How to password-protect content on Linux and Nginx in 4 steps using HTTP Authentication.'
tweetVia: 'flsilva7'
