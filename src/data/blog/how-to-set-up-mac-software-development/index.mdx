...
In this post, you'll find a list of the most popular [Code Editors](/blog/how-to-set-up-mac-software-development/#1-code-editor) and links with step-by-step guides on how to install [Homebrew](/blog/how-to-set-up-mac-software-development/#3-homebrew), [Git](/blog/how-to-set-up-mac-software-development/#4-git), [Node.js](http://localhost:8000/blog/how-to-set-up-mac-software-development/#nodejs), [Oh My Zsh](http://localhost:8000/blog/how-to-set-up-mac-software-development/#6-antigen-and-oh-my-zsh), [how to generate and use SSH keys](http://localhost:8000/blog/how-to-set-up-mac-software-development/#7-ssh-keys), and more.
