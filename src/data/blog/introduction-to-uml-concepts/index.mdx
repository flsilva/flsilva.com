...
description: Get an introduction to what UML is, what are models, requirements, use cases, and more.
heroImage: './hero.jpg'
heroImageCreditText: 'Image by rawpixel.com on Freepik'
heroImageCreditUrl: 'https://www.freepik.com/free-photo/writing-work-process_18411602.htm#&position=30&from_view=undefined'
priority: 0.6
slug: 'introduction-to-uml-concepts'
tags: ['uml']
title: Introduction to UML
tweetText: 'Get an introduction to what UML is, what are models, requirements, use cases, and more.'
tweetVia: 'flsilva7'
...
<ImageWithCaption caption="Philippe Kruchten's 4+1 architectural view model.">
  ![Philippe Kruchten's 4+1 architectural view model.](./4-1-view-model.jpg)
</ImageWithCaption>
