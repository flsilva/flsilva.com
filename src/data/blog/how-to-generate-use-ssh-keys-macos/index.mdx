...
description: In this step-by-step guide, you'll learn how to generate SSH keys on macOS, why you should use passphrases, how to prevent typing passphrases every time you start an SSH connection, and how to use your SSH keys on GitHub.
heroImage: './hero.jpg'
...
In this step-by-step guide, you'll learn how to generate SSH keys on macOS, why you should use passphrases, how to prevent typing passphrases every time you start an SSH connection, and how to use your SSH keys on GitHub.
...
1. Using the `ssh-agent` tool. This way requires you to run two commands and type your passphrase every time you create a new macOS user session (typically after a computer reboot). [Use ssh-agent](/blog/how-to-generate-use-ssh-keys-macos/#what-is-the-ssh-agent-and-how-to-use-it) if you prefer this way.
...
**Note:** You don't have to worry about the `ssh-agent` if you didn't type a passphrase when you generated your keys. In that case, head to the [How to use your SSH keys on GitHub](/blog/how-to-generate-use-ssh-keys-macos/#how-to-use-your-ssh-keys-on-github) section.
...
I could describe here the steps to add it to GitHub, but GitHub itself has a [page dedicated to it](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account), so you can follow the steps there and get back here to test if it works and finish reading this guide. Just make sure you select `Authentication Key` on the `Key type` dropdown.
