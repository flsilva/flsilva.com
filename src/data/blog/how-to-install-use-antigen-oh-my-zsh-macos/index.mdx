...
description: Antigen and Oh My Zsh are a great combination that allows you to customize Zsh to your liking easily. Learn how to install both in six easy steps.
heroImage: './hero.jpg'
priority: 0.6
