...
If you know the _`~/.zshrc`_ file and how to use it, you can [skip to the next section](/blog/how-to-install-use-antigen-oh-my-zsh-macos/#step-3-using-antigen-adding-configuration-to-your-zshrc-file).
