...
You can skip to the [next section](/blog/how-to-install-nodejs-nvm-macos/#step-1-make-sure-you-dont-have-nvm-installed-already) if you already have a _`~/.zshrc`_ file.
...
If you see something like _`0.39.3`_, you already have it installed! So you can head to [Step 4. Install a Node version with nvm](/blog/how-to-install-nodejs-nvm-macos/#step-4-install-a-node-version-with-nvm).
