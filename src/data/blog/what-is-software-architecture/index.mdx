...
<div style={{ width: '100%', flexDirection: 'row', justifyContent: 'center', margin: '4rem 0' }}>
  <div style={{ maxWidth: '35%', height: 'auto', flexGrow: 1 }}>
    <ImageWithCaption caption="Layered Architecture">
      ![Layered Architecture](./layered-architecture-01.png)
    </ImageWithCaption>
  </div>
</div>
