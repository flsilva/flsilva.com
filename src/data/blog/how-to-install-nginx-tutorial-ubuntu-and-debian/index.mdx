...
description: 'Learn how to install Nginx on Debian or Ubuntu in 5 steps.'
heroImage: './hero.jpg'
...
title: How to install Nginx on Linux
tweetText: 'Learn how to install Nginx on Debian & Ubuntu'
tweetVia: 'flsilva7'
