...
description: In this step-by-step guide, you'll learn how to sign your Git commits and tags using SSH keys on macOS, how to set up Git to remember your passphrase, and how to verify your signed commits and tags locally and on GitHub.
heroImage: './hero.jpg'
heroImageCreditText: 'Image by Freepik'
heroImageCreditUrl: 'https://www.freepik.com/free-vector/neon-fingerprint-background_6148287.htm'
priority: 0.6
slug: 'how-to-sign-git-commits-ssh-keys-macos'
tags: ['git', 'macos', 'security', 'ssh-keys']
title: How to sign Git commits with SSH keys on macOS
tweetText: 'How to sign Git commits with SSH keys on macOS.'
tweetVia: 'flsilva7'
---
...
I could describe the steps here to add it to GitHub, but GitHub itself has a [page dedicated to it](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account), so you can follow the steps there and get back here to test if it works and finish reading this guide. **Make sure you select** `Signing Key` on the `Key type` dropdown instead of `Authentication Key`.
