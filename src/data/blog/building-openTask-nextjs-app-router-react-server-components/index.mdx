...
description: 'Learn how I built OpenTask, an open-source MVP task management web app, using the new Next.js App Router, React Server Components, Server Actions, Suspense, Tailwind CSS, Radix, Supabase, and Prisma.'
heroImage: './hero.png'
heroImageCreditText: ''
heroImageCreditUrl: ''
priority: 0.6
slug: 'building-opentask-nextjs-app-router-react-server-components'
tags: ['react', 'nextjs', 'opentask', 'nexar', 'hybrid-web-app-model']
title: 'Building OpenTask with Next.js App Router and RSCs'
tweetText: 'Learn how I built OpenTask, an open-source MVP task management web app with @nextjs App Router, @reactjs Server Components, Server Actions, @tailwindcss, @supabase, @prisma, and more.'
tweetVia: 'flsilva7'
