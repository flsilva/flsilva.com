...
Schin Casa com Tudo was a successful national scoped promotion hired by soft drinks company <a href="https://web.archive.org/web/20121209070623/http://www.brasilkirin.com.br/" target="_blank">Schincariol</a> (acquired by Kirin Japanese company in 2012).
...
{""}<a href="https://www.youtube.com/watch?v=hWSI0bkF4EU&ab_channel=LariMunh%C3%B3s" target="\_blank" style={{ lineBreak: "anywhere" }}>https://www.youtube.com/watch?v=hWSI0bkF4EU&ab_channel=LariMunh%C3%B3s</a>
...
<FlexBoxRowSpaceBetween>
  ...
  <LinkButtonRightArrowIcon
    align-self="flex-end"
    text="Conspiração Filmes"
    to="/portfolio/conspiracao/"
  />
</FlexBoxRowSpaceBetween>
