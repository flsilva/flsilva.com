...
I designed and implemented the application architecture, the "Home" screen using <a href="https://en.wikipedia.org/wiki/Papervision3D" target="_blank">Papervision3D</a>, and the "Mapa do Site" (Sitemap) screen and mentored other developers and motion designers to implement and integrate the remaining screens and UI components.
