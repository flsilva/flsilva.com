...
<FlexBoxRowSpaceBetween>
  <LinkButtonLeftArrowIcon align-self="flex-start" text="Imprint" to="/portfolio/imprint/" />
  <LinkButtonRightArrowIcon align-self="flex-end" text="Pearson" to="/portfolio/pearson/" />
</FlexBoxRowSpaceBetween>
