...
export const date = "2023-06-15T00:00:00";
...
export const heroImageCreditUrl =
  "https://www.freepik.com/free-vector/flat-design-cms-illustration_12067674.htm";
...
export const slug = "how-to-install-git-with-homebrew-on-macos";

export const tags = ["git", "macos", "homebrew"];

export const title = "How to install Git with Homebrew on macOS";

export const tweetText = "How to install Git with Homebrew on macOS.";
...
In that case, you can head to the [How to update Git](#how-to-update-git) section at the end of this post.
