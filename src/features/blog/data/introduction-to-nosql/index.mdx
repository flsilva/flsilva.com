...
In this article I'll present a brief introduction to what [NoSQL](http://en.wikipedia.org/wiki/NoSQL) is, why to use it, and the basics of its four main data models: [Key-Value](#key-value-model), [Document](#document-model), [Column-Family](#column-family-model) and [Graph](#graph-model).
