...
export const date = "2023-06-28T00:00:00";
...
export const heroImageCreditUrl =
  "https://www.freepik.com/free-photo/html-system-website-concept_41740250.htm";

export const heroImageHeight = 1335;

export const heroImageWidth = 2000;

export const priority = 0.6;

export const slug = "how-to-set-up-mac-software-development";

export const tags = ["macos"];

export const title = "How to set up your Mac for software development";

export const tweetText = "How to set up your Mac for software development";
...
In this post, you'll find a list of the most popular [Code Editors](#1-code-editor) and links with step-by-step guides on how to install [Homebrew](#3-homebrew), [Git](#4-git), [Node.js](#nodejs), [Oh My Zsh](#6-antigen-and-oh-my-zsh), [how to generate and use SSH keys](#7-ssh-keys), and more.
...
Microsoft's [Visual Studio Code](https://code.visualstudio.com/) is the most popular code editor in the world.
...
[Vim](https://www.vim.org/) is a free and open-source code editor with exceptional features, including its famous _Command Mode_, where you type commands as shortcuts to edit your code. But it has a steeper learning curve and is more popular on Linux.

[Neovim](https://neovim.io/) is built on top of Vim and is seen as an improvement.

#### Xcode

Great for: Swift and Objective-C for developing apps for the Apple ecosystem.

Apple's [Xcode](https://developer.apple.com/xcode/) is the the-facto IDE for Mac developers working with the Apple ecosystem. If you plan to develop native macOS, iOS, watchOS, or TvOS apps, you'll use it.

#### IntelliJ IDEA

Great for: Java, Kotlin, Scala, and Android apps.

JetBrains's [IntelliJ IDEA](https://www.jetbrains.com/idea/) is one of the most popular IDEs for Java and Android software development. It's been highly regarded for decades, and Google has built Android Studio on top of it, specially tailored for Android software development.

#### Android Studio

Great for: Android development with Java and Kotlin.

Google's [Android Studio](https://developer.android.com/studio) is the official IDE for Android software development, built on top of IntelliJ IDEA. If you plan to develop Android apps, this is where you should start.

#### PyCharm

Great for: Python.

JetBrains's [PyCharm](https://www.jetbrains.com/pycharm/) is one of the most popular IDEs for Python software development, and it's also built on top of IntelliJ IDEA.

#### Visual Studio

Great for: .NET, C#, and C++ for developing apps for the Windows ecosystem.

Microsoft's [Visual Studio](https://visualstudio.microsoft.com/) is the the-facto IDE for Windows developers working with the .NET platform. It's like Apple's Xcode but for Windows. It does include a native macOS version.

### 2. Command Line Developer Tools

<InfoBox theme="warning">
  If you know you will install [Xcode](#xcode), you can skip this step since the
  Command Line Developer Tools is installed when you install Xcode. But if
  you're not sure you need Xcode, you can install the tools, as Xcode is a lot
  heavier to download and install (7GB+), while the tools are lightweight.
</InfoBox>
...
### 5. Zsh (no need to install it anymore 🤙)

We no longer need to install [Zsh](https://zsh.sourceforge.io/), as it is the default [shell](https://en.wikipedia.org/wiki/Unix_shell) app starting from macOS Catalina (2019)! 🎉 Bye-bye, [Bash](<https://en.wikipedia.org/wiki/Bash_(Unix_shell)>).
