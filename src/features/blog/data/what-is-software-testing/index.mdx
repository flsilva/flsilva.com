...
export const date = "2013-02-05T00:00:00";

export const dateUpdated = "2024-03-20T00:00:00";
...
export const heroImageCreditText = "Image by pressfoto on Freepik";

export const heroImageCreditUrl =
  "https://www.freepik.com/free-photo/programmer-scanning-screen-his-smartwatch-with-smartphone-camera_5698347.htm#page=3&query=software%20testing&position=7&from_view=search&track=ais";
...
export const slug = "what-is-software-testing";

export const tags = ["software-testing"];

export const title = "What is software testing?";
