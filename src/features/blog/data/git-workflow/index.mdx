...
If you're new to [Git](https://git-scm.com/) or want to know a little more about its basics and its distributed
...
[Git](https://git-scm.com/) works with the concept of three different file states: [_committed_](#committed-files), [_modified_](#modified-files) and [_staged_](#staged-files) (Chacon 8).
