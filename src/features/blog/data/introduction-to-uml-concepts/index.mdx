...
- [Unified Modeling Language (Wikipedia)](https://en.wikipedia.org/wiki/Unified_Modeling_Language)<br />
- [4+1 architectural view model (Wikipedia)](https://en.wikipedia.org/wiki/4%2B1_Architectural_View_Model)<br />
- [Object Management Group (Wikipedia)](https://en.wikipedia.org/wiki/Object_Management_Group)

## Bibliography

- Miles, Russ and Kim Hamilton. _Learning UML 2.0_. O'Reilly Media, Inc, 2006.

- "Unified Modeling Language" _Wikipedia_ , n.d. Web. 20 December 2010 &#60;<A href="https://en.wikipedia.org/wiki/Unified_Modeling_Language" style={{ lineBreak: 'anywhere' }}>ht<span />tp://en.wikipedia.org/wiki/Unified_Modeling_Language</A>&#62;
