...
export const date = "2024-02-08T00:00:00";
...
export const slug =
  "building-opentask-nextjs-app-router-react-server-components";

export const tags = ["react", "nextjs", "opentask", "nexar"];

export const title = "Building OpenTask with Next.js App Router and RSCs";

export const tweetText =
  "Learn how I built OpenTask, an open-source MVP task management web app with @nextjs App Router, @reactjs Server Components, Server Actions, @tailwindcss, @supabase, @prisma, and more.";
...
The resulting application is [OpenTask](https://opentask.app/): an [open-source](https://github.com/flsilva/opentask) and responsive MVP task management web application.
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Project Page on iPhone">
      ![Project
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-project-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "720px", flexGrow: 1 }}>
    <ImageWithCaption caption="Project Page on iPad">
      ![Project Page -
      OpenTask](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-ipad-landscape-14-2024-02-07-project-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
To understand how and why we got here and what problems they solve alongside the new Next.js App Router, please read my article [React Server Components and a new hybrid web app model](/blog/react-server-components-and-a-new-hybrid-web-app-model/).
...
A task management app is well-known and simple enough to build as part of a case study. Nonetheless, it includes common features in most apps, such as authentication, data fetching, data mutation, data relationships, and UI elements like forms and dialogs.
...
<InfoBox>
  I explain routing and business feature modules, alongside other codebase
  conventions you'll see in the following sections, in
  [Nexar](https://nexar.dev), the application architecture OpenTask implements.
  If you haven't read it, please do so now, as it'll help you understand
  OpenTask's implementation more easily and quickly. I explain Nexar with
  OpenTask's codebase, so you'll learn both simultaneously.
</InfoBox>
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Landing Page on iPhone">
      ![Landing
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-mkt-landing-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "720px", flexGrow: 1 }}>
    <ImageWithCaption caption="Landing Page on iPad">
      ![Landing Page -
      OpenTask](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-ipad-landscape-14-2024-02-07-mkt-landing-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
  ...
  return (
    <ShowContentTransition>
      <div className="pt-24 sm:pt-36 lg:pt-42">
        ...
        <HeroCopy>
          Get focused by organizing your plans and goals with simple projects
          and tasks.
        </HeroCopy>
...
export const HeroCopy = ({
  ...
  <p className={twMerge("mt-6 text-xl leading-8 text-gray-800", className)}>
    {children}
  </p>
);
```
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Sign In Page on iPhone">
      ![Sign In
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-sign-in-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "720px", flexGrow: 1 }}>
    <ImageWithCaption caption="Sign In Page on iPad">
      ![Sign In
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-ipad-landscape-14-2024-02-07-sign-in-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Install PWA on Android">
      ![Install PWA on
      Android](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-galaxy-s20-ultra-2024-02-07-install-pwa-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Install PWA on iPhone">
      ![Install PWA on
      iPhone](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-install-pwa-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Main Menu Dialog Page on iPhone">
      ...
      iPhone](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-main-menu-dialog-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Main Menu Page on iPhone">
      ![Main Menu Page on
      iPhone](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-main-menu-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Onboarding Page on iPhone">
      ![Onboarding
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-onboarding-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "720px", flexGrow: 1 }}>
    <ImageWithCaption caption="Onboarding Page on iPad">
      ![Onboarding Page -
      OpenTask](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-ipad-landscape-14-2024-02-07-onboarding-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
  ...
  return (
    <>
      ...
      <Link
        ...
        className={twMerge(buttonGreenClassName, "w-fit mt-8")}
      >
        Create your first!
      </Link>
    </>
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="New Project Dialog Page on iPhone">
      ![New Project Dialog
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-new-project-dialog-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "720px", flexGrow: 1 }}>
    <ImageWithCaption caption="New Project Dialog Page on iPad">
      ...
      OpenTask](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-ipad-landscape-14-2024-02-07-new-project-dialog-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
export default function NewProjectDialogPage() {
  return (
    <Dialog
      ...
      routerActionOnClose={RouterActions.Back}
    >
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="New Project Page on iPhone">
      ![New Project
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-new-project-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "720px", flexGrow: 1 }}>
    <ImageWithCaption caption="New Project Page on iPad">
      ![New Project Page -
      OpenTask](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-ipad-landscape-14-2024-02-07-new-project-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
Wait, what?! You haven't signed up? You're kidding, right? 😅
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Project Page Menu on iPhone">
      ![Project Page
      Menu](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-project-header-menu-open-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Edit Project Dialog Page on iPhone">
      ![Edit Project Dialog
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-edit-project-dialog-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "720px", flexGrow: 1 }}>
    <ImageWithCaption caption="Edit Project Dialog Page on iPad">
      ...
      OpenTask](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-ipad-landscape-14-2024-02-07-edit-project-dialog-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
export default function EditProjectDialogPage({
  ...
  return (
    ...
    >
      <Suspense
        fallback={
          <ProjectFormSkeleton className="mt-6" ssrOnly="Loading project..." />
        }
      >
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Edit Project Page on iPhone">
      ![Edit Project
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-edit-project-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "720px", flexGrow: 1 }}>
    <ImageWithCaption caption="Edit Project Page on iPad">
      ![Edit Project Page -
      OpenTask](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-ipad-landscape-14-2024-02-07-edit-project-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
export const ProjectForm = async ({
  ...
  return (
    <Form action={formAction}>
      ...
      ></textarea>
      <FormErrorList />
      <SubmitButton className={twMerge(buttonGreenClassName, "flex self-end")}>
        Save
      </SubmitButton>
    </Form>
  );
...
export const createProject = async (
  ...
  try {
    ...
    return createServerErrorResponse<ProjectDto>(
      genericAwareOfInternalErrorMessage
    );
  }
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Active Projects Page on iPhone">
      ![Active Projects
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-active-projects-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "720px", flexGrow: 1 }}>
    <ImageWithCaption caption="Active Projects Page on iPad">
      ...
      OpenTask](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-ipad-landscape-14-2024-02-07-active-projects--no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
export default function ActiveProjectsPage() {
  ...
  return (
    <>
      ...
      <Suspense
        fallback={<ProjectListSkeleton ssrOnly="Loading projects..." />}
      >
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Archived Projects Page on iPhone">
      ![Archived Projects
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-archived-projects-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "720px", flexGrow: 1 }}>
    <ImageWithCaption caption="Archived Projects Page on iPad">
      ...
      OpenTask](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-ipad-landscape-14-2024-02-07-archived-projects--no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
export default function ArchivedProjectsPage() {
  const empty = (
    <p className="text-sm font-medium text-gray-600">No archived projects.</p>
  );
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Project Page Skeleton on iPhone">
      ![Project Page
      Skeleton](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-project-skeleton-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "720px", flexGrow: 1 }}>
    <ImageWithCaption caption="Project Page Skeleton on iPad">
      ...
      OpenTask](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-ipad-landscape-14-2024-02-07-project-skeleton-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
import {
  ...
  TaskDto,
  getTasks,
} from "../data-access/TasksDataAccess";
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="New Task Dialog Page on iPhone">
      ![New Task Dialog
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-new-task-dialog-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
export default function NewTaskDialogPage({
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="New Task Page on iPhone">
      ![New Task
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-new-task-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "720px", flexGrow: 1 }}>
    <ImageWithCaption caption="Project Page with New Task Form on iPad">
      ...
      OpenTask](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-ipad-landscape-14-2024-02-07-project-new-task-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
    ...
    <div className={twJoin(containerClassName)}>
      ...
      >
        <button
          ...
          className={twMerge(
            buttonLinkClassName,
            "group py-4  flex-row self-start",
            className
          )}
        >
          <PlusSignalIcon
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Task Dialog Page on iPhone">
      ![Task Dialog
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-task-dialog-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "720px", flexGrow: 1 }}>
    <ImageWithCaption caption="Task Dialog Page on iPad">
      ![Task Dialog Page -
      OpenTask](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-ipad-landscape-14-2024-02-07-task-dialog-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
export default function TaskDialogPage({
  ...
  return (
    ...
    >
      <Suspense
        fallback={
          <TaskFormSkeletonSkeleton
            className="mt-6"
            ssrOnly="Loading task..."
          />
        }
      >
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Task Page on iPhone">
      ![Task
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-task-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "720px", flexGrow: 1 }}>
    <ImageWithCaption caption="Task Page on iPad">
      ![Task Dialog Page -
      OpenTask](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-ipad-landscape-14-2024-02-07-task-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Today Page on iPhone">
      ![Today
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-today-no-tasks-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "720px", flexGrow: 1 }}>
    <ImageWithCaption caption="Today Page on iPad">
      ![Today Page -
      OpenTask](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-ipad-landscape-14-2024-02-07-today-no-tasks-no-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
export default async function TodayPage() {
  ...
  return (
    <>
      ...
      <Suspense
        fallback={
          <TaskListSkeleton className="mt-3" ssrOnly="Loading tasks..." />
        }
      >
          ...
          {({ list: listOverdue, tasks: tasksOverdue }) => (
            <>
              {tasksOverdue.length > 0 && (
                <p className="mb-4 text-xs font-semibold">Overdue</p>
              )}
              {listOverdue}
              {tasksOverdue.length > 0 && (
                <p className="mt-8 mb-4 text-xs font-semibold">Today</p>
              )}
                  ...
                  <>
                    ...
                    {tasksDueToday.length < 1 && (
                      <p className="mt-6 mb-6 text-sm font-medium text-gray-600">
                        No tasks due today.{" "}
                        {tasksOverdue.length < 1 && "Enjoy your day!"}
                      </p>
                    )}
                  </>
                )}
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Today Page on iPhone">
      ![Today
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-today-due-today-tasks-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Today Page on iPhone">
      ![Today
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-today-due-today-and-overdue-tasks-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
>
  <div style={{ maxWidth: "280px", flexGrow: 1 }}>
    <ImageWithCaption caption="Today Page on iPhone">
      ![Today
      Page](/images/blog/building-opentask-nextjs-app-router-react-server-components/screenshot-iphone-14-2024-02-07-today-overdue-tasks-browser.png)
    </ImageWithCaption>
  </div>
</div>
...
I postponed writing tests for the MVP because I used new tools and techniques, including [React Server Components](/blog/react-server-components-and-a-new-hybrid-web-app-model/) and [Server Actions](/blog/react-server-components-and-a-new-hybrid-web-app-model/#server-actions), and I needed to figure out what the codebase would look like. I also wanted to move fast while experimenting with those new features.
...
<InfoBox>
What do you think about the engineering of OpenTask? Do you like the codebase? What about what you _don't_ like?
...
<SocialMediaShareButtons
  hashtags={["react", "nextjs", "open-task"]}
  ...
  tweetVia="flsilva7"
  url="https://flsilva.com/blog/building-opentask-nextjs-app-router-react-server-components"
/>
