...
export const date = "2012-12-11T00:00:00";
...
export const slug = "introducing-git";

export const tags = ["git"];

export const title = "Introduction to Git";

export const tweetText = "Introduction to Git";
