...
export const date = "2010-04-01";

export const description =
  "Java + ActionScript 3.0 project developed for Grafikonstruct in 2010.";

export const heroImage = "schin2010-05.jpg";
...
export const name = "Schin Caiu na Rede";

export const shortInfo = "Adobe Flash web app (April 2010 - August 2010)";

export const slug = "schin-caiu-na-rede";
...
The [Mood](https://www.agenciamood.com.br) agency (acquired by TBWA\Lew Lara) was in charge of the project and [Grafikonstruct](https://www.linkedin.com/company/grafikonstruct/) developed the interative web app.
...
I led a team of five Grafikonstruct developers to build the Adobe Flash ActionScript 3.0 client-side application. I architected the whole client-side solution based on an ActionScript 3.0 application framework I was building at the time (v2). It featured a modular architecture mainly based on the [MVC](https://en.wikipedia.org/wiki/Model%E2%80%93view%E2%80%93controller) ([pureMVC](https://puremvc.org)) and [IoC](https://en.wikipedia.org/wiki/Inversion_of_control) ([Spring ActionScript (archive)](https://web.archive.org/web/20120111035944/http://www.springactionscript.org/)) patterns. It depended on seven other .swc libraries I developed myself, including [AS3CoreAddendum](https://as3coreaddendum.flsilva.com/), [AS3Utils](https://as3utils.flsilva.com/), [AS3Collections](https://as3collections.flsilva.com/) and the previous version of [VostokFramework](https://vostokframework.flsilva.com/).

The application architecture was modular and contained more than ten modules compiled through an automated build & deploy environment set up by myself using [Apache Ant](https://ant.apache.org). I implemented the Model, Controller, and Services layers of the app and mentored the implementation of the View layer by Grafikonstruct's team. I implemented about 65% of all application-specific code.
...
[Nationwide TV ad #1 (30 seconds YouTube video)](https://www.youtube.com/watch?v=ZPRnws3msyI)

[Nationwide TV ad #2 (1 min. YouTube video)](https://www.youtube.com/watch?feature=player_embedded&v=meWydco5RSI)
