...
export const date = "2014-10-01";

export const description =
  "Ruby on Rails + AngularJS projects developed for Imprint Partners, Inc between October 2014 and October 2016.";

export const heroImage = "imprint-01.jpg";

export const imageWidth = 800;

export const imageHeight = 486;

export const name = "Imprint";

export const shortInfo =
  "Desktop and mobile web apps (October 2014 - October 2016)";

export const slug = "imprint";
