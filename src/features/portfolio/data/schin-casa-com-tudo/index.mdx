...
export const date = "2009-08-01";

export const description =
  ".NET + ActionScript 3.0 project developed for Grafikonstruct in 2009.";

export const heroImage = "schin2009-13.jpg";
...
export const imageHeight = 448;

export const name = "Schin Casa com Tudo";

export const shortInfo = "Adobe Flash web app (August 2009 - October 2009)";

export const slug = "schin-casa-com-tudo";
