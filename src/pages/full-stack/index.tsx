...
const DeliveryPage: React.FC<PageProps> = () => (
  <LayoutCampaign>
    <header className={header}>
      ...
      <h4 style={{ marginTop: '0' }}>Need results now? Hire a results-driven Full-Stack expert.</h4>
    </header>
    <div className={copyImageContainer}>
      ...
      <p>
        Here&#39;s why you should hire me as your <b>Full-Stack Expert now:</b>
      </p>
      <ul style={{ display: 'block' }}>
        ...
        <li>
          ...
          <a href="https://github.com/flsilva/opentask">open-source</a> Next.js App Router PWA MVP
          as part of a{' '}
