...
const DeliveryPage: React.FC<PageProps> = () => (
  <LayoutCampaign>
    ...
    <div className={copyImageContainer}>
      ...
      <p>
        Here&#39;s why you should hire me as your <b>Senior React Collaborator:</b>
      </p>
      <ul style={{ display: 'block' }}>
        ...
        <li>
          ...
          , an application architecture for full-stack React + Next.js App Router apps I designed
          while building OpenTask.
        </li>
      </ul>
      ...
      <p style={{ margin: '4rem 0', textAlign: 'center' }}>
        ...
        >
          Hire a Senior React Collaborator
        </a>
      </p>
...
export const Head: HeadFC = () => (
  <SEO
    ...
    pagePath=""
    title="Remote React Engineer - Flavio Silva"
  />
);
