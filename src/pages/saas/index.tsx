  ...
  <LayoutCampaign>
    <header className={header}>
      ...
      <h4 style={{ marginTop: '0' }}>
        Need a SaaS MVP fast? Hire a results-driven senior collaborator.
      </h4>
    </header>
    <div className={copyImageContainer}>
      ...
      <p>
        Here&#39;s why you should hire me as your senior collaborator <b>to build your SaaS MVP:</b>
      </p>
      ...
      <h5 style={{ marginTop: '3rem', textAlign: 'center' }}>
        I&#39;m available today to discuss your SaaS MVP idea.{' '}
      </h5>
...
export const Head: HeadFC = () => (
  <SEO
    ...
    pagePath=""
    title="Remote SaaS Engineer - Flavio Silva"
  />
);
